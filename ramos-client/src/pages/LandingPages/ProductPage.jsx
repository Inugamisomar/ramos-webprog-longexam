      ...
      <div className="flex w-full flex-col gap-6">
        <section className="border-y-2 border-zinc-900 bg-zinc-50 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
          <div className="mx-auto max-w-3xl">
            ...
            <Button to="/products" className="mt-6 !bg-yellow-400 !text-black hover:!bg-yellow-500">
              Back to Products
            </Button>
          </div>
        </section>
    ...
    <div className="flex w-full flex-col gap-6">
      ...
      <section className="border-y-2 border-zinc-900 bg-zinc-50 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        <div className="max-w-3xl">
          <div className="mb-4">
            <Button to="/products" className="!bg-yellow-400 !text-black hover:!bg-yellow-500">
              Back to Products
            </Button>
          </div>
      ...
      <section className="border-y-2 border-zinc-900 bg-zinc-50 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-8 border-t-2 border-zinc-900 pt-6">
            ...
            <Button to="/products" className="mt-4 !bg-yellow-400 !text-black hover:!bg-yellow-500">
              Back to Products
            </Button>
          </div>
